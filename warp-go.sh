...
check_operating_system() {
  ...
  SYSTEMCTL_START=("service warp-go start" "service warp-go start" "service warp-go start" "/opt/warp-go/warp-go --config=/opt/warp-go/warp.conf" "service warp-go start" "/opt/warp-go/warp-go --config=/opt/warp-go/warp.conf")
  SYSTEMCTL_STOP=("service warp-go stop" "service warp-go stop" "service warp-go stop" "kill -15 $(pgrep warp-go)" "service warp-go stop" "kill -15 $(pgrep warp-go)")
  SYSTEMCTL_RESTART=("service warp-go restart" "service warp-go restart" "service warp-go restart" "alpine_warp_restart" "service wg-quick@wgcf restart" "alpine_warp_restart")
  SYSTEMCTL_ENABLE=("chkconfig warp-go on" "chkconfig warp-go on" "chkconfig warp-go on" "alpine_wgcf_enable" "chkconfig warp-go on")
